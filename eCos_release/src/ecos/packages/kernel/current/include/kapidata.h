...
# define CYG_THREAD_CPULOAD_MEMBER 				\
	cyg_uint64			time_start;				\
	cyg_uint64			time_used;				\
	cyg_uint64			time_period_used[8];	\
	cyg_uint32			cpuload_switches;		\
	cyg_uint32			period_switches[8];		\
	cyg_uint64			time_start_swtich;
#else
# define CYG_THREAD_CPULOAD_MEMBER
#endif
