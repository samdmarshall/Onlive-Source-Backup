...
externC cyg_uint32 hal_get_system_clock(void);
externC cyg_uint32 hal_get_timeslice_period(void);

#ifdef CYGSEM_KERNEL_SCHED_TIMESLICE_PRECISE

#define GET_SYSTEM_CLOCK					hal_get_system_clock
#define GET_TIMESLICE_PERIOD				hal_get_timeslice_period
#define DELTA_SYSTEM_CLOCK(a, b)			((a < b) ? (b-a): ~(a-b))
