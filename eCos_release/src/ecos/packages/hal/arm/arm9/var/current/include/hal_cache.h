...
#elif defined(CYGPKG_HAL_ARM_ARM9_ARM926EJS)
...
# define CYGHWR_HAL_ARM_ARM946ES_CLEAN_DCACHE //has instruction to clean D-cache
...
CYG_MACRO_END
#elif defined(CYGHWR_HAL_ARM_ARM946ES_CLEAN_DCACHE)
#define HAL_DCACHE_SYNC()                                               \
CYG_MACRO_START                                                         \
    asm volatile (                                                      \
    	"mov 	r1, #0;" 												\
