...
#define HWF_TRAFO_LESS_ENABLE	0x00008000UL	/* Enable PHY Trafo-less */
#define HWF_PHY_CLASS_A_100BT	0x00004000UL	/* Enable PHY Class 100Base-T */
...
#define HW_MS_TO_TICKS(pAC, MsTime) \
	((MsTime) * (1000L * (pAC)->GIni.GIHstClkFact * SK_FACT_62) / SK_FACT_100)
