...
#define	PCIE_OUR4_PEX_LTSSM_STATE_MSK			SHIFT25(0x7fL)
#define	PCIE_OUR4_PEX_LTSSM_STATE_BASE			25
#define	PCIE_OUR4_GPHY_INT_ASPM					BIT_24			/* GPHY Get INT */
#define	PCIE_OUR4_TIM_VAL_MSK					SHIFT16(0xffL)	/* Timer Value */
...
#define	CONFIG_REG0_RTC_MSK							SHIFT24(0xffL)	/* RTC Timing */
#define	CONFIG_REG0_RTC_BASE						24
#define	CONFIG_REG0_WTC_MSK							SHIFT16(0xffL)	/* WTC Timing */
...
#define	VPD_CTRL_ADD_VPD_END_MSK			SHIFT24(0xffL)	/* VPD_END */
#define	VPD_CTRL_ADD_VPD_END_BASE			24
#define	VPD_CTRL_ADD_VPD_W_START_MSK		SHIFT16(0xffL)	/* VPD_W_START */
...
#define	FLASH_LDR_CTRL_FLASH_ADDR_MSK				SHIFT16(0x3fffL)
...
#define	OTP_LDR_CTRL_OTP_ADDR_MSK					SHIFT16(0x7fffL)/* OTP Address */
...
#define	OTP_MEM_CTRL_0_CE2RD_SU_TIME_MSK		SHIFT24(0xffL)	/* CERD setup time */
...
/* CPUMPEN hold time */
#define	OTP_MEM_CTRL_1_CPUMEM_HLD_TIME_MSK		SHIFT28(0xfL)
#define	OTP_MEM_CTRL_1_CPUMEM_HLD_TIME_BASE		28
/* CPUMPEN setup time */
#define	OTP_MEM_CTRL_1_CPUMEM_SU_TIME_MSK		SHIFT24(0xfL)
#define	OTP_MEM_CTRL_1_CPUMEM_SU_TIME_BASE		24
#define	OTP_MEM_CTRL_1_PGMEN_HLD_TIME_MSK		SHIFT16(0xffL)	/* PGMEN hold time */
...
#define	OTP_MEM_CTRL_2_OTP_DBG_BITS_MSK			SHIFT16(0xffffL)
...
#define	PCIE_LNKCAP_PORT_NUM_MSK			SHIFT24(0xffL)	/* Port Number */
...
#define	PCIE_FC_PH_INIT_MSK			SHIFT24(0xffL)
...
#define	TX1_AVB_ST			0x0D7C	/* 32 bit	Transmit Queue 1 AVB
									 *			Status Register
									 */
#define	TXMF_TCTL3			0x0D88	/* 32 bit	Transmit MAC FIFO
									 *			Control/Test Register
									 */
...
#define	TXMF_TCTL5			0x0348	/* 32 bit	Transmit MAC FIFO
									 *			Control/Test Register
									 */
...
#define	SPI_LCFG_NRML_ADDR_MSK			SHIFT16(0xfffL)
...
#define	SPI_VCFG_VPD_END_MSK			SHIFT16(0xfffL)	/* VPD end address */
...
#define	SPI_OPC1_RDSR_MSK		SHIFT24(0xffL)	/* Opcode Read Status */
#define	SPI_OPC1_RDSR_BASE		24
#define	SPI_OPC1_RDID_MSK		SHIFT16(0xffL)	/* Opcode Read ID */
...
#define	SPI_OPC2_CE_MSK			SHIFT24(0xffL)	/* Opcode Chip Erase */
...
#define	CFG_MADDR_HI_VAL_3_MSK		SHIFT24(0xffL)	/* Mac-Address_x, Byte 3 */
#define	CFG_MADDR_HI_VAL_3_BASE		24
#define	CFG_MADDR_HI_VAL_2_MSK		SHIFT16(0xffL)	/* Mac-Address_x, Byte 2 */
...
#define	CFG_CDIV_MSK					SHIFT16(0xffL)	/* Clock Div Value */
...
#define	SRAM_TC_BMU_TX_FIFO_RTC_MSK			SHIFT22(0x3)	/* BMU TX FIFO RTC */
#define	SRAM_TC_BMU_TX_FIFO_RTC_BASE		22
#define	SRAM_TC_BMU_TX_FIFO_WTC_MSK			SHIFT20(0x3)	/* BMU TX FIFO WTC */
#define	SRAM_TC_BMU_TX_FIFO_WTC_BASE		20
/* Power Budgeting FIFO RAM RTC */
#define	SRAM_TC_PWR_BDGT_FIFO_RTC_MSK		SHIFT18(0x3)
#define	SRAM_TC_PWR_BDGT_FIFO_RTC_BASE		18
/* Power Budgeting FIFO RAM WTC */
#define	SRAM_TC_PWR_BDGT_FIFO_WTC_MSK		SHIFT16(0x3)
...
#define	ASF_TO_0_3_ASF_TO3_MSK		SHIFT24(0xffL)	/* Timeout Value 3 */
#define	ASF_TO_0_3_ASF_TO3_BASE		24
#define	ASF_TO_0_3_ASF_TO2_MSK		SHIFT16(0xffL)	/* Timeout Value 2 */
...
#define	FLASH_MEM_CMD_CMD_CODE_MSK			SHIFT16(0xffL)
...
#define	FLASH_MEM_STATUS_CONFIG_VAL_MSK			SHIFT16(0xffL)	/* Config Data */
...
#define	RPFU_FIFO_WR_WSPTR_MSK				SHIFT16(0xffL)
...
#define	RPFU_FIFO_LEV_SLEV_MSK				SHIFT16(0xffL)	/* FIFO Shadow Level */
...
#define TBMU_LE_SEL_MSK                 SHIFT16(0x7)    /* LE ADD HI selection */
...
#define TX_RATE_LIMIT_FLOW_LO_LIMIT_MSK        SHIFT16(0xffff)
...
#define TX_RATE_FRAC_RATE_DEN_MSK      SHIFT16(0xffff)
...
#define TX_RATE_GAP_GAP_ADJ_MSK        SHIFT16(0xff)
...
#define TX_AVB_ST_MONITOR_SEL_MSK      SHIFT30(0x3)    /* Monitor Status Selection */
...
#define	HCU_HCSR_CPU_RST_WDOG_TIMER_MSK			SHIFT24(0xffL)
...
#define STAT_TX_REP_EVEN_REPORT_INDEX_MSK      SHIFT16(0xfff)
...
#define MAC_CTRL_PD_FIFO_DEEP_MSK       SHIFT27(0x3)    /* FIFO Deep Default */
 ...
 *								memory
 */
#define	PHY_CFG_STAT_MSK				SHIFT24(0xffL)	/* PHY Status */
...
#define	WOL_MADDR_LO_MAC_3_MSK		SHIFT24(0xffL)	/* MAC<3> */
...
#define CLASS_A_RATE_FRAC_CLASS_A_RATE_DEN_MSK      SHIFT16(0xffff)
...
/* Class A Low Limit */
#define CLASSA_RATE_LIMIT_CLASS_A_LO_LIMIT_MSK      SHIFT16(0xffff)
...
#define CLASS_A_ST_MONITOR_SEL_MSK      SHIFT30(0x3)    /* Monitor Status Selection */
...
#define CLASS_B_RATE_FRAC_CLASS_B_RATE_DEN_MSK      SHIFT16(0xffff)
...
/* Class B Low Limit */
#define CLASSB_RATE_LIMIT_CLASS_B_LO_LIMIT_MSK      SHIFT16(0xffff)
...
#define CLASS_B_ST_MONITOR_SEL_MSK      SHIFT30(0x3)    /* Monitor Status Selection */
...
#define	USB_HWHOST_TTPER_MSK			SHIFT24(0xffL)	/* TTPER */
