		       ...
		       struct ktermios *old)
{
	...
	/*
	 * Hack:
	 * Berlin's default baudrate 14400 doesn't exist in table, we have
	 * to use some other value to set baudrate to 14400. so never set
	 * baudrate to 1200.
	 */
	if (baud == 1200)
		baud = GALOIS_UART_BAUDRATE;
#endif
