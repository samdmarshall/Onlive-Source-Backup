...
static yaffs_Device bigblockDev;
...
int yaffs_StartUp(void)
{
	...
	// the file emulation space as
	// 2kpage/64chunk per block/128MB device
	memset(&bigblockDev,0,sizeof(bigblockDev));

	bigblockDev.totalBytesPerChunk = 2048;
	bigblockDev.nChunksPerBlock = PAGES_PER_BLOCK;
	bigblockDev.nReservedBlocks = 2;
	//flashDev.checkpointStartBlock = 1;
	//flashDev.checkpointEndBlock = 20;
	bigblockDev.startBlock = 0;
	//flashDev.endBlock = 99; //200 // Make it smaller
	bigblockDev.endBlock = yflash2_GetNumberOfBlocks()-1;
	bigblockDev.isYaffs2 = 1;
	bigblockDev.wideTnodesDisabled=0;
	bigblockDev.nShortOpCaches = 10; // Use caches
	bigblockDev.genericDevice = (void *) 2;	// Used to identify the device in fstat.
	bigblockDev.name = "sim2k";
	bigblockDev.writeChunkWithTagsToNAND = yflash2_WriteChunkWithTagsToNAND;
	bigblockDev.readChunkWithTagsFromNAND = yflash2_ReadChunkWithTagsFromNAND;
	bigblockDev.eraseBlockInNAND = yflash2_EraseBlockInNAND;
	bigblockDev.initialiseNAND = yflash2_InitialiseNAND;
	bigblockDev.markNANDBlockBad = yflash2_MarkNANDBlockBad;
	bigblockDev.queryNANDBlock = yflash2_QueryNANDBlock;
	bigblockDev.skipCheckpointRead = bigblockDev.skipCheckpointWrite = 1;
#ifdef YAFFS_ACP
	bigblockDev.acpDisabled = 1;
#endif
