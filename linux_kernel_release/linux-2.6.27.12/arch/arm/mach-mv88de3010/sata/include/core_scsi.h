 ...
 * SCSI command
 */
#define SCSI_CMD_SPRUCE_DOWNLOAD_CODE	0xF2
#define SCSI_CMD_SPRUCE_WRITE_BUFFER	0x3B
#define SCSI_CMD_SPRUCE_READ_BUFFER		0x3C
...
/*
 * The sense data is returned from SCSI target 
 * when the initiator issues REQUEST_SENSE_COMMAND
 */
