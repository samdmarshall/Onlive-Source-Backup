...
//in seconds
#define HBA_ATA_REQ_TIMER 8
#define HBA_ATA_REQ_TIMER_AFTER_RESET 8
#define HBA_ATAPI_REQ_TIMER 10
#define HBA_ATAPI_REQ_TIMER_AFTER_RESET 10
#define HBA_REQ_TIMER_IOCTL 10//(HBA_REQ_TIMER_AFTER_RESET+3)
