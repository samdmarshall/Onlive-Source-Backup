...
pmlan_buffer wlan_alloc_mlan_buffer(mlan_adapter * pmadapter,
                                    pmlan_callbacks pcb, t_u32 data_len);
/** function to free a mlan_buffer */
t_void wlan_free_mlan_buffer(mlan_adapter * pmadapter, pmlan_callbacks pcb,
                             pmlan_buffer pmbuf);
...
/** 
 *  @brief This function returns priv based on the bss_num
 *  
