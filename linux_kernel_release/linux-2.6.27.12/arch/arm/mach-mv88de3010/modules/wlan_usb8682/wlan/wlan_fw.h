...
typedef struct _MrvlIEtypes_PMK_t
{
    ...
    MrvlIEtypesHeader_t Header;
        /** PMK */
    u8 PMK[1];
} __ATTRIB_PACK__ MrvlIEtypes_PMK_t;
...
typedef struct _MrvlIEtypes_Passphrase_t
{
    ...
    MrvlIEtypesHeader_t Header;
        /** Passphrase */
    char Passphrase[1];
} __ATTRIB_PACK__ MrvlIEtypes_Passphrase_t;
/* unicastCipher -
 *	Bit 0   : RFU
 *	Bit 1   : RFU
 *	Bit 2	: TKIP
...
typedef struct _MrvlIEtypes_Cipher_t
{
    ...
    u8 pairCipher;
        /** GroupCipher */
    u8 groupCipher;
} __ATTRIB_PACK__ MrvlIEtypes_Cipher_t;
/* rsnMode -	
 *	Bit 0    : No RSN
 *	Bit 1-2  : RFU
 *	Bit 3    : WPA
...
typedef struct _MrvlIEtypes_EncrProto_t
{
    ...
    MrvlIEtypesHeader_t Header;
        /** EncrProto */
    u16 rsnMode;
} __ATTRIB_PACK__ MrvlIEtypes_EncrProto_t;
/** MrvlIEtypes_Bssid_t */
typedef struct _MrvlIEtypes_Bssid_t
{
    ...
    MrvlIEtypesHeader_t Header;
        /** Bssid */
    u8 Bssid[ETH_ALEN];
} __ATTRIB_PACK__ MrvlIEtypes_Bssid_t;
...
typedef struct _HostCmd_DS_802_11_SUPPLICANT_PMK
{
    ...
    u8 TlvBuffer[1];
	  ...
	  **/
} __ATTRIB_PACK__ HostCmd_DS_802_11_SUPPLICANT_PMK;
...
} __ATTRIB_PACK__ HostCmd_DS_802_11_SUPPLICANT_PROFILE;
